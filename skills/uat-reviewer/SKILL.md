---
name: anti-legacy:uat-reviewer
description: >-
  Independent UAT reviewer. READ-ONLY validation that generated target code
  implements the business rules + test-contract scenarios; returns a structured
  PASS/FAIL verdict in isolation from the developer. Use when: dispatched by
  anti-legacy:uat-crew to validate a domain's requirements against contracts.
---
