...
gate/audit contract can see it. Registration reuses scripts/manifest.py's own
...
# --------------------------------------------------------------------------- #
# Manifest registration (reuses scripts/manifest.py helpers — single source of
...
def _register_artifact(manifest_path, artifact_id, doc_abs_path):
    ...
    import manifest as mf  # noqa: E402  (path-injected import, intentional)
